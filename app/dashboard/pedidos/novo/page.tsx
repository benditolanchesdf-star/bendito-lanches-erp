...
import { FILIAL_ID, formatBRL, CANAIS, FORMAS_PAGAMENTO, ROTAS_ENTREGA } from '@/lib/constants'
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-xl shadow-md p-5 space-y-3">
            ...
            <Field label="Observações"><Textarea rows={2} value={observacoes} onChange={(e) => setObservacoes(e.target.value)} /></Field>
              <Field label="Rota de entrega">
                <Select value={rotaEntrega} onChange={(e) => setRotaEntrega(e.target.value)}>
